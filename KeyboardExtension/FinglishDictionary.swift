...
class FinglishDictionary {
    ...
    private func buildDictionary() {
        ...
        // ===========================================
        // EXPANDED VERB CONJUGATIONS
        // ===========================================
        addWords([
            // raftan (to go) - All persons present
            ("miravam", ["می‌روم"], 90),
            ("miravi", ["می‌روی"], 90),
            ("miravad", ["می‌رود"], 90),
            ("miravim", ["می‌رویم"], 90),
            ...
            // khordan (to eat) - All forms
            ("mikhoram", ["می‌خورم"], 95),
            ("mikhori", ["می‌خوری"], 95),
            ("mikhore", ["می‌خوره"], 95),
            ("mikhoreh", ["می‌خوره"], 93),
            ("mikhorim", ["می‌خوریم"], 92),
            ("mikhorin", ["می‌خورین"], 90),
            ("mikhoran", ["می‌خورن"], 90),
            ("khordam", ["خوردم"], 98),
            ("khordi", ["خوردی"], 98),
            ("khord", ["خورد"], 98),
            ...
            ("khastan", ["خواستن"], 88),
            ("nemikham", ["نمی‌خوام"], 98),
            ("nemikhai", ["نمی‌خوای"], 95),
            ("nemikhad", ["نمی‌خواد"], 95),
            ("bkham", ["بخوام"], 92),
            ("bekham", ["بخوام"], 90),
            ("bekhay", ["بخوای"], 90),

            // danestan (to know) - All forms
            ("midunam", ["می‌دونم"], 98),
            ("midoonam", ["می‌دونم"], 96),
            ("miduni", ["می‌دونی"], 98),
            ("midooni", ["می‌دونی"], 96),
            ...
            ("danesti", ["دانستی"], 88),
            ("danest", ["دانست"], 88),
            ("nemidunam", ["نمی‌دونم"], 98),
            ("nemidoonam", ["نمی‌دونم"], 96),
            ("nemiduni", ["نمی‌دونی"], 95),
            ("nemidune", ["نمی‌دونه"], 95),
            ("bdunam", ["بدونم"], 90),
            ("bedunam", ["بدونم"], 92),
            ("beduni", ["بدونی"], 90),

            // tunestan/tavanestan (to be able) - All forms
            ("mitunam", ["می‌تونم"], 98),
            ("mitoonam", ["می‌تونم"], 96),
            ("mituni", ["می‌تونی"], 98),
            ("mitooni", ["می‌تونی"], 96),
            ...
            ("tunesti", ["تونستی"], 88),
            ("tunest", ["تونست"], 88),
            ("nemitunam", ["نمی‌تونم"], 98),
            ("nemitoonam", ["نمی‌تونم"], 96),
            ("nemituni", ["نمی‌تونی"], 95),
            ("nemitune", ["نمی‌تونه"], 95),
            ("betunam", ["بتونم"], 92),
            ("betoonam", ["بتونم"], 90),
            ("betuni", ["بتونی"], 90),

            // zadan (to hit/play) - All forms
            ("mizanam", ["می‌زنم"], 95),
            ("mizani", ["می‌زنی"], 95),
            ("mizane", ["می‌زنه"], 95),
            ("mizaneh", ["می‌زنه"], 93),
            ...
            // gereftan (to take/get) - All forms
            ("migiram", ["می‌گیرم"], 95),
            ("migiri", ["می‌گیری"], 95),
            ("migire", ["می‌گیره"], 95),
            ("migireh", ["می‌گیره"], 93),
            ...
            // neveshtan (to write) - All forms
            ("minevisam", ["می‌نویسم"], 92),
            ("minevisi", ["می‌نویسی"], 92),
            ("minevise", ["می‌نویسه"], 92),
            ("mineviseh", ["می‌نویسه"], 90),
            ("minevisim", ["می‌نویسیم"], 88),
            ("minevisin", ["می‌نویسین"], 85),
            ("minevisan", ["می‌نویسن"], 85),
            ("neveshtam", ["نوشتم"], 95),
            ("neveshti", ["نوشتی"], 95),
            ("nevesht", ["نوشت"], 95),
            ("neveshtim", ["نوشتیم"], 92),
            ...
            ("benevis", ["بنویس"], 95),
            ("benevisi", ["بنویسی"], 92),
            ("benevisim", ["بنویسیم"], 90),
            ("nanevis", ["ننویس"], 90),

            // khundan/khandan (to read) - All forms
            ("mikhunam", ["می‌خونم"], 95),
            ("mikhoonam", ["می‌خونم"], 93),
            ("mikhuni", ["می‌خونی"], 95),
            ("mikhooni", ["می‌خونی"], 93),
            ("mikhune", ["می‌خونه"], 95),
            ("mikhooneh", ["می‌خونه"], 93),
            ("mikhunim", ["می‌خونیم"], 92),
            ("mikhunin", ["می‌خونین"], 90),
            ("mikhunan", ["می‌خونن"], 90),
            ("khundam", ["خوندم"], 95),
            ("khoondam", ["خوندم"], 93),
            ("khundi", ["خوندی"], 95),
            ...
            // fahmidan (to understand) - All forms
            ("mifahmam", ["می‌فهمم"], 95),
            ("mifahmi", ["می‌فهمی"], 95),
            ("mifahme", ["می‌فهمه"], 95),
            ("mifahmeh", ["می‌فهمه"], 93),
            ("mifahmim", ["می‌فهمیم"], 92),
            ("mifahmin", ["می‌فهمین"], 90),
            ("mifahman", ["می‌فهمن"], 90),
            ("fahmidam", ["فهمیدم"], 98),
            ("fahmidi", ["فهمیدی"], 98),
            ("fahmid", ["فهمید"], 98),
            ...
            ("fahmidin", ["فهمیدین"], 92),
            ("fahmidan", ["فهمیدن"], 92),
            ("nemifahmam", ["نمی‌فهمم"], 95),
            ("nemifahmi", ["نمی‌فهمی"], 92),
            ("nemifahme", ["نمی‌فهمه"], 92),
            ("befahm", ["بفهم"], 92),
            ("befahmi", ["بفهمی"], 90),
            ("befahmim", ["بفهمیم"], 88),

            // shodan (to become) - All forms
            ("misham", ["میشم"], 98),
            ("mishi", ["میشی"], 98),
            ("mishe", ["میشه"], 98),
            ("misheh", ["میشه"], 96),
            ...
            // khabidan (to sleep) - All forms
            ("mikhabam", ["می‌خوابم"], 92),
            ("mikhabi", ["می‌خوابی"], 92),
            ("mikhabe", ["می‌خوابه"], 92),
            ("mikhabim", ["می‌خوابیم"], 90),
            ("mikhabin", ["می‌خوابین"], 88),
            ("mikhaban", ["می‌خوابن"], 88),
            ("khabidam", ["خوابیدم"], 95),
            ("khabidi", ["خوابیدی"], 95),
            ("khabid", ["خوابید"], 95),
            ("khabidim", ["خوابیدیم"], 92),
            ("khabidin", ["خوابیدین"], 90),
            ("bekh", ["بخواب"], 95),
            ("bekhab", ["بخواب"], 98),
            ("bekhabi", ["بخوابی"], 92),
            ("bekhabim", ["بخوابیم"], 90),
            ...
            // fekr kardan (to think) - forms
            ("fekr mikonam", ["فکر می‌کنم"], 95),
            ("fekr mikoni", ["فکر می‌کنی"], 95),
            ("fekr mikone", ["فکر می‌کنه"], 95),
            ("fekr mikonim", ["فکر می‌کنیم"], 92),
            ("fekr kardam", ["فکر کردم"], 95),
            ("fekr kardi", ["فکر کردی"], 95),
            ("fekr kard", ["فکر کرد"], 95),
            ("fekr kardim", ["فکر کردیم"], 92),
            ("fekr bokon", ["فکر بکن"], 90),
            ("fekr nakon", ["فکر نکن"], 90),

            // gush dadan (to listen) - forms
            ("gush midam", ["گوش میدم"], 92),
            ("gush midi", ["گوش میدی"], 92),
            ("gush mide", ["گوش میده"], 92),
            ("gush midim", ["گوش میدیم"], 90),
            ("gush dadam", ["گوش دادم"], 95),
            ("gush dadi", ["گوش دادی"], 95),
            ("gush dad", ["گوش داد"], 95),
            ("gush bede", ["گوش بده"], 92),
            ("gush kon", ["گوش کن"], 95),
            ("gush koni", ["گوش کنی"], 92),

            // negah kardan (to look) - forms
            ("negah mikonam", ["نگاه می‌کنم"], 92),
            ("negah mikoni", ["نگاه می‌کنی"], 92),
            ("negah mikone", ["نگاه می‌کنه"], 92),
            ("negah kardam", ["نگاه کردم"], 95),
            ("negah kardi", ["نگاه کردی"], 95),
            ("negah kard", ["نگاه کرد"], 95),
            ("negah kon", ["نگاه کن"], 98),
            ("negah koni", ["نگاه کنی"], 95),
            ("negah nakon", ["نگاه نکن"], 92),

            // doost dashtan (to like/love) - forms
            ("dost daram", ["دوست دارم"], 98),
            ("dust daram", ["دوست دارم"], 96),
            ("dost dari", ["دوست داری"], 98),
            ("dust dari", ["دوست داری"], 96),
            ("dost dare", ["دوست داره"], 98),
            ("dost darim", ["دوست داریم"], 95),
            ("dost darin", ["دوست دارین"], 92),
            ("dost daran", ["دوست دارن"], 92),
            ("dost dashtam", ["دوست داشتم"], 95),
            ("dost dashti", ["دوست داشتی"], 95),
            ("dost dasht", ["دوست داشت"], 95),
            ("dost nadashtam", ["دوست نداشتم"], 90),
            ("dost nadaram", ["دوست ندارم"], 95),
            ("dost nadari", ["دوست نداری"], 92),

            // yad gereftan (to learn) - forms
            ("yad migiram", ["یاد می‌گیرم"], 92),
            ("yad migiri", ["یاد می‌گیری"], 92),
            ("yad migire", ["یاد می‌گیره"], 92),
            ("yad migirim", ["یاد می‌گیریم"], 90),
            ("yad gereftam", ["یاد گرفتم"], 95),
            ("yad gerefti", ["یاد گرفتی"], 95),
            ("yad gereft", ["یاد گرفت"], 95),
            ("yad begir", ["یاد بگیر"], 95),
            ("yad begiri", ["یاد بگیری"], 92),

            // yad dadan (to teach) - forms
            ("yad midam", ["یاد میدم"], 92),
            ("yad midi", ["یاد میدی"], 92),
            ("yad mide", ["یاد میده"], 92),
            ("yad midim", ["یاد میدیم"], 90),
            ("yad dadam", ["یاد دادم"], 95),
            ("yad dadi", ["یاد دادی"], 95),
            ("yad dad", ["یاد داد"], 95),
            ("yad bede", ["یاد بده"], 92),
            ("yad bedi", ["یاد بدی"], 90),
        ])
        ...
        addWords([
            ...
            ("bozorge", ["بزرگه"], 95),
            ("bozorgtar", ["بزرگتر"], 92),
            ("bozorgtarin", ["بزرگترین"], 90),
            ("kuchik", ["کوچیک"], 98),
            ("koochik", ["کوچیک"], 96),
            ("kuchike", ["کوچیکه"], 95),
            ("kuchiktar", ["کوچیکتر"], 92),
            ("kuchiktarin", ["کوچیکترین"], 90),
            ("kuchulu", ["کوچولو"], 95),
            ("koocholoo", ["کوچولو"], 93),
            ("gonde", ["گنده"], 92),
            ("gondeh", ["گنده"], 90),
            ...
            ("khoshgel", ["خوشگل"], 98),
            ("khoshgele", ["خوشگله"], 96),
            ("khoshgeltar", ["خوشگل‌تر"], 92),
            ("khoshgeltarin", ["خوشگل‌ترین"], 90),
            ("jaleb", ["جالب"], 98),
            ("jalebe", ["جالبه"], 96),
            ("jalebtar", ["جالب‌تر"], 92),
            ("jalebtarin", ["جالب‌ترین"], 90),

            // Personality adjectives
            ("mehraban", ["مهربان"], 92),
            ("mehrabane", ["مهربانه"], 90),
            ("mehraboon", ["مهربون"], 95),
            ("mehraboone", ["مهربونه"], 93),
            ("bakhshande", ["بخشنده"], 88),
            ("khasise", ["خسیسه"], 85),
            ("khasis", ["خسیس"], 88),
            ("asabani", ["عصبانی"], 95),
            ("asabanie", ["عصبانیه"], 93),
            ...
            ("tanbal", ["تنبل"], 90),
            ("tanbale", ["تنبله"], 88),
            ("sakhtkoosh", ["سخت‌کوش"], 85),
            ("portalaash", ["پرتلاش"], 82),

            // Temperature/state adjectives
            ("garm", ["گرم"], 95),
            ("garme", ["گرمه"], 93),
            ("garmtar", ["گرمتر"], 90),
            ("sard", ["سرد"], 95),
            ...
            ("unjur", ["اون‌جور"], 94),
            ("unjor", ["اون‌جور"], 92),
            ("hamunjur", ["همون‌جور"], 94),
            ("hamunjor", ["همون‌جور"], 92),
        ...
        addWords([
            ...
            ("laptop", ["لپ‌تاپ"], 95),
            ("laptap", ["لپ‌تاپ"], 93),
            ("computer", ["کامپیوتر"], 90),
            ("kamputer", ["کامپیوتر"], 88),
            ("rayane", ["رایانه"], 85),
            ("tablet", ["تبلت"], 92),
            ("tablete", ["تبلته"], 90),
            ("saat", ["ساعت"], 98),
            ...
            ("taksi", ["تاکسی"], 95),
            ("taksie", ["تاکسیه"], 90),
            ("havapeima", ["هواپیما"], 90),
            ("havapiymaa", ["هواپیما"], 88),
            ("plane", ["هواپیما"], 85),
            ("airplane", ["هواپیما"], 82),
            ("ghatar", ["قطار"], 90),
            ("qatar", ["قطار"], 88),
            ...
            ("apple", ["سیب"], 88),
            ("portegal", ["پرتقال"], 92),
            ("portegale", ["پرتقاله"], 90),
            ("orange", ["پرتقال"], 85),
            ("moz", ["موز"], 92),
            ("moze", ["موزه"], 90),
            ("banana", ["موز"], 85),
            ("hendevane", ["هندوانه"], 90),
            ("hendevaneh", ["هندوانه"], 88),
            ("watermelon", ["هندوانه"], 82),
            ("talebi", ["طالبی"], 88),
            ("talebii", ["طالبی"], 86),
            ("melon", ["طالبی"], 82),
            ("angur", ["انگور"], 90),
            ...
            ("nooshabeh", ["نوشابه"], 88),
            ("soda", ["نوشابه"], 85),
            ("soft drink", ["نوشابه"], 82),
            ("abe jush", ["آب جوش"], 85),
            ("abjush", ["آب‌جوش"], 82),
            ("boiling water", ["آب جوش"], 78),
            ("abe yakh", ["آب یخ"], 88),
            ("abyakh", ["آب‌یخ"], 85),
            ("ice water", ["آب یخ"], 80),
            ...
            ("barghe", ["برقه"], 88),
            ("lightning", ["برق"], 82),
            ("rangin kaman", ["رنگین‌کمان"], 85),
            ("rainbow", ["رنگین‌کمان"], 80),
            ("meh", ["مه"], 90),
            ("mehe", ["مهه"], 88),
            ("fog", ["مه"], 85),
            ("shabnam", ["شبنم"], 85),
            ("dew", ["شبنم"], 78),
            ("nam nam baran", ["نم‌نم باران"], 80),
            ("drizzle", ["نم‌نم"], 75),
            ...
            ("home", ["خانه"], 88),
            ("house", ["خانه"], 85),
            ("apartment", ["آپارتمان"], 88),
            ("aparteman", ["آپارتمان"], 90),
            ("apartemaan", ["آپارتمان"], 88),
            ("otagh", ["اتاق"], 95),
            ("otaaq", ["اتاق"], 93),
            ("room", ["اتاق"], 88),
            ("ashpazkhane", ["آشپزخانه"], 90),
            ("ashpazkhooneh", ["آشپزخونه"], 92),
            ("kitchen", ["آشپزخانه"], 85),
            ("hamam", ["حمام"], 95),
            ("hammam", ["حمام"], 93),
            ("bathroom", ["حمام"], 88),
            ("dastshui", ["دستشویی"], 92),
            ("dastshuii", ["دستشویی"], 90),
            ("restroom", ["دستشویی"], 85),
            ("toilet", ["دستشویی"], 82),
            ("havli", ["حیاط"], 88),
            ("hayaat", ["حیاط"], 90),
            ...
            ("bridge", ["پل"], 85),
            ("forudgah", ["فرودگاه"], 90),
            ("forodgaah", ["فرودگاه"], 88),
            ("airport", ["فرودگاه"], 85),
            ("istgah", ["ایستگاه"], 92),
            ("istgaah", ["ایستگاه"], 90),
            ("station", ["ایستگاه"], 85),
            ("bimarestan", ["بیمارستان"], 90),
            ("bimaarestaan", ["بیمارستان"], 88),
            ("hospital", ["بیمارستان"], 85),
            ("darmangah", ["درمانگاه"], 85),
            ("clinic", ["کلینیک"], 82),
            ("klinik", ["کلینیک"], 85),
            ("darukhane", ["داروخانه"], 90),
            ("darukhaaneh", ["داروخانه"], 88),
            ("pharmacy", ["داروخانه"], 85),
            ("maghaze", ["مغازه"], 95),
            ("maghazeh", ["مغازه"], 93),
            ("shop", ["مغازه"], 88),
            ("store", ["مغازه"], 85),
            ("supermarket", ["سوپرمارکت"], 90),
            ("supermareket", ["سوپرمارکت"], 88),
            ("bazar", ["بازار"], 95),
            ("bazaar", ["بازار"], 93),
            ("market", ["بازار"], 88),
            ("resturan", ["رستوران"], 92),
            ("restooran", ["رستوران"], 90),
            ("restaurant", ["رستوران"], 88),
            ("cafe", ["کافه"], 92),
            ("kaafe", ["کافه"], 90),
            ("coffee shop", ["کافه"], 85),
            ("hotel", ["هتل"], 92),
            ("hotele", ["هتله"], 90),
            ("mosaferkhaneh", ["مسافرخانه"], 85),
            ("inn", ["مسافرخانه"], 80),
            ("bank", ["بانک"], 95),
            ("baank", ["بانک"], 93),
            ("ketabkhane", ["کتابخانه"], 90),
            ("ketaabkhaaneh", ["کتابخانه"], 88),
            ("library", ["کتابخانه"], 85),
            ("daneshgah", ["دانشگاه"], 95),
            ("daaneshgaah", ["دانشگاه"], 93),
            ("university", ["دانشگاه"], 88),
            ("madrese", ["مدرسه"], 95),
            ("madreseh", ["مدرسه"], 93),
            ("school", ["مدرسه"], 88),
        ...
        // ===========================================
        // EXPANDED COLLOQUIAL & INTERNET SLANG
        // ===========================================
        addWords([
            // Common internet/texting slang
            ("khodet", ["خودت"], 98),
            ("khodetam", ["خودتم"], 95),
            ("khodam", ["خودم"], 98),
            ("khodesh", ["خودش"], 98),
            ...
            ("hamchi", ["همچی"], 90),
            ("hamechiz", ["همه‌چیز"], 88),
            ("hame chiz", ["همه چیز"], 92),
            ("hamechin", ["همه‌چین"], 85),
            ("haminjur", ["همینجور"], 90),
            ("haminjuri", ["همینجوری"], 92),
            ("haminjor", ["همینجور"], 88),
            ("hamintori", ["همینطوری"], 90),
            ("hamintor", ["همینطور"], 88),
            ("injuri", ["اینجوری"], 95),
            ("injori", ["اینجوری"], 93),
            ("injur", ["اینجور"], 92),
            ...
            // More slang expressions
            ("top", ["توپ"], 92),
            ("toop", ["توپ"], 90),
            ("awesome", ["عالی"], 85),
            ("daamet garm", ["دمت گرم"], 95),
            ("damet garm", ["دمت گرم"], 98),
            ("dastet dard nakone", ["دستت درد نکنه"], 90),
            ("dast dard", ["دستت درد نکنه"], 85),
            ("khaste nabashi", ["خسته نباشی"], 95),
            ("khaste nabashi", ["خسته نباشی"], 93),
            ("ghorbune dahanet", ["قربون دهنت"], 85),
            ("gorbunet", ["قربونت"], 95),
            ("ghorboonet", ["قربونت"], 93),
            ("alaki", ["الکی"], 95),
            ("alakii", ["الکی"], 93),
            ("fake", ["الکی"], 85),
            ("jedi nagi", ["جدی نگی"], 88),
            ("jedi nagu", ["جدی نگو"], 90),
            ("rast migi", ["راست میگی"], 92),
            ("raast migi", ["راست میگی"], 90),
            ("dorugh migi", ["دروغ میگی"], 90),
            ("dorogh migi", ["دروغ میگی"], 88),
            ("dorough", ["دروغ"], 92),
            ("dorugh", ["دروغ"], 95),
            ("rast", ["راست"], 95),
            ("raast", ["راست"], 93),
            ...
            ("well done", ["آفرین"], 85),
            ("mashallah", ["ماشاالله"], 92),
            ("maashaallaah", ["ماشاالله"], 90),
            ("inshallah", ["ان‌شاءالله"], 95),
            ("inshaallaah", ["ان‌شاءالله"], 93),
            ("inshaallah", ["ان‌شاءالله"], 92),
            ("hopefully", ["ان‌شاءالله"], 85),
            ("alhamdolellah", ["الحمدلله"], 90),
            ("alhamdulillah", ["الحمدلله"], 88),
            ("thank god", ["الحمدلله"], 85),
            ("khoda ro shokr", ["خدا رو شکر"], 92),
            ("khodaro shokr", ["خدا رو شکر"], 90),
            ("astaghfurallah", ["استغفرالله"], 85),
            ("nauzobillah", ["نعوذبالله"], 82),
            ("tobaa", ["توبه"], 88),
            ("tobe", ["توبه"], 90),
            ...
            ("nashod", ["نشد"], 95),
            ("nashud", ["نشد"], 93),
            ("nemitonam", ["نمیتونم"], 98),
            ("nemitoonam", ["نمیتونم"], 96),
            ("cant", ["نمیتونم"], 82),
            ("mituni", ["میتونی"], 98),
            ("mitooni", ["میتونی"], 96),
            ...
            ("chi shod", ["چی شد"], 95),
            ("chi shode", ["چی شده"], 98),
            ("chi shodeh", ["چی شده"], 96),
            ("whats up", ["چی شده"], 82),
            ("khabare", ["خبره"], 92),
            ("khabar chi", ["خبر چی"], 90),
            ("khabari", ["خبری"], 92),
            ("news", ["خبر"], 85),
            ("che khabari", ["چه خبری"], 90),
            ("kojai", ["کجایی"], 98),
            ("kojayi", ["کجایی"], 96),
            ("kojaei", ["کجایی"], 94),
            ...
            ("chigofti", ["چی گفتی"], 92),
            ("what did you say", ["چی گفتی"], 80),
            ("chi kar mikoni", ["چیکار میکنی"], 92),
            ("chikar mikoni", ["چیکار میکنی"], 95),
            ("what are you doing", ["چیکار میکنی"], 80),
            ("barname chie", ["برنامه چیه"], 90),
            ("barname chi", ["برنامه چی"], 88),
            ("what's the plan", ["برنامه چیه"], 78),
            ("hame chi", ["همه چی"], 95),
            ("hamechi", ["همه‌چی"], 93),
            ("everything", ["همه‌چیز"], 85),
        ])
        ...
        addWords([
            ...
            ("bbkhshid", ["ببخشید"], 90),
            ("bebkhshid", ["ببخشید"], 93),
            ("bebbakhshid", ["ببخشید"], 88),
            ("khdhfz", ["خداحافظ"], 85),
            ("khodafz", ["خداحافظ"], 90),
            ("khdahfz", ["خداحافظ"], 88),
            ("shb khsh", ["شب خوش"], 88),
            ("shab khosh", ["شب خوش"], 95),
            ("shabkhosh", ["شب خوش"], 90),
            ("rz khsh", ["روز خوش"], 85),
            ("roz khosh", ["روز خوش"], 92),
            ("rozkhosh", ["روز خوش"], 88),
            ("sbh bkhir", ["صبح بخیر"], 85),
            ("sobh bkhir", ["صبح بخیر"], 90),
            ("sob bekhir", ["صبح بخیر"], 88),
        ])
    }
